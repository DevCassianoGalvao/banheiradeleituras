...
// 1) tenta o cache primeiro — nunca chama a OpenAI se já existe entrada
...
// 2) grava no cache pra próxima consulta (de qualquer usuário) não pagar de novo
$upsert = $pdo->prepare('
...
echo json_encode(['ok' => true, 'tag' => $tag, 'pages' => $pages, 'note' => $note, 'cached' => false]);
